...
import {isUserLoggedIn, getLoggedInUser, logout, setLoggedInUserRole} from "@/service/AuthService";
...
const Navbar = () => {
    ...
    return (
        <>
        <nav className={`flexBetween max-container padding-container relative z-30 py-4 ${isLoggingOut ? 'fade-out' : ''}`}>
            <Link href="/">
                ...
                {isLogin && (
                    <div className="flex">
                        ...
                        <Link href="/">
                            ...
                            {/*className="px-7 py-3 mt-4 rounded-2xl bg-gray-30 text-2xl hover:bg-gray-20 text-white">Logout</button>*/}
                        </Link>
                    </div>
